      ...
      app/
        components/
          app/
            ...
            app.html
            app.ts
          analysis-sidebar.component.ts
          analysis.page.ts
          debrief-sidebar.component.ts
          debrief.page.ts
          dock.page.ts
          handoff-sidebar.component.ts
          handoff.page.ts
          mission-sidebar.component.ts
          mission.page.ts
          ops-shell.page.ts
          route-inputs.ts
          scene-styles.ts
...
## File: apps/app1/public/.gitkeep
````

````

## File: apps/app1/src/app/components/app/app.css
````css
:host {
  display: block;
  min-height: 100vh;
...
/* Signature ruler: a fine tick strip along the top edge of the shell,
   like the bezel markings on an instrument panel. Replaces the previous
   soft neon blobs -- restrained, and it reads as instrumentation rather
...
.command-bar {
  ...
  background:
    linear-gradient(180deg, rgb(20 16 12 / 0.94), rgb(9 7 5 / 0.92)),
    var(--panel-base);
...
.brand__mark {
  ...
  box-shadow:
    inset 0 0 0 1px rgb(90 217 255 / 0.12),
    0 0 16px rgb(90 217 255 / 0.16);
}
...
.status-chip {
  ...
  background: rgb(16 13 10 / 0.86);
  transition:
    border-color 180ms ease,
    background-color 180ms ease;
}

.console-shell--transitioning .status-chip {
...
.transition-rail {
  ...
  background: rgb(148 200 176 / 0.1);
  overflow: hidden;
}

.transition-rail__thumb {
  position: absolute;
  inset: 0 auto 0 0;
  width: 22%;
  background: linear-gradient(
    90deg,
    rgb(90 217 255 / 0) 0%,
    rgb(90 217 255 / 0.9) 40%,
    rgb(90 217 255 / 0.9) 60%,
    rgb(90 217 255 / 0) 100%
  );
  transform: translateX(-150%);
  opacity: 0;
  animation: rail-pass 480ms cubic-bezier(0.22, 1, 0.36, 1) 1;
}

.transition-rail__mesh {
  position: absolute;
  inset: 0;
  background: var(--ruler-ticks);
  opacity: 0.5;
...
## File: apps/app1/src/app/components/app/app.html
````html
<div
  class="console-shell"
  [class.console-shell--transitioning]="isTransitioning()"
  [attr.data-phase]="phaseLabel()"
>
  <header class="command-bar">
    <a class="brand" [routerLink]="'/'">
      <span class="brand__mark">SB</span>
      <span class="brand__copy">
        <strong>Orbital Switchboard</strong>
        <small>Frame-first relay deck</small>
      </span>
    </a>
    ...
    <nav class="command-nav" aria-label="Primary navigation">
      ...
      <a
        [routerLink]="{
          name: 'analysis',
          params: { missionId: 315 },
          query: { lens: 'echo', detail: 3 },
        }"
      >
        Analysis 315
      </a>
      <a [routerLink]="'/legacy'">Legacy vector</a>
    </nav>

    <section class="status-cluster" aria-label="Navigation status">
  ...
  <div class="transition-rail" aria-hidden="true">
    <div class="transition-rail__mesh"></div>
    @if (hasHeaderPulse()) {
      @for (token of [currentHeaderPulseToken()]; track token) {
        <span class="transition-rail__thumb"></span>
      }
    }
  </div>
...
## File: apps/app1/src/app/components/app/app.ts
````typescript
...
## File: apps/app1/src/app/components/analysis-sidebar.component.ts
````typescript
import {
  Component,
  input,
...
## File: apps/app1/src/app/components/analysis.page.ts
````typescript
import {
  Component,
  inject,
...
## File: apps/app1/src/app/components/debrief-sidebar.component.ts
````typescript
import {
  Component,
  input,
...
## File: apps/app1/src/app/components/debrief.page.ts
````typescript
import {
  Component,
  inject,
...
## File: apps/app1/src/app/components/dock.page.ts
````typescript
...
## File: apps/app1/src/app/components/handoff-sidebar.component.ts
````typescript
...
## File: apps/app1/src/app/components/handoff.page.ts
````typescript
import {
  Component,
  inject,
...
## File: apps/app1/src/app/components/mission-sidebar.component.ts
````typescript
import {
  Component,
  input,
...
## File: apps/app1/src/app/components/mission.page.ts
````typescript
import {
  Component,
  inject,
...
## File: apps/app1/src/app/components/ops-shell.page.ts
````typescript
import {
  Component,
  inject,
...
## File: apps/app1/src/app/components/route-inputs.ts
````typescript
...
## File: apps/app1/src/app/components/scene-styles.ts
````typescript
...
## File: apps/app1/src/app/frames/analysis.frame.ts
````typescript
...
## File: apps/app1/src/app/frames/debrief.frame.ts
````typescript
import { inject } from '@angular/core';
import {
  frame,
...
## File: apps/app1/src/app/frames/dock.frame.ts
````typescript
import {
  frame,
  view,
...
## File: apps/app1/src/app/frames/handoff.frame.ts
````typescript
import { inject } from '@angular/core';
import {
  frame,
...
## File: apps/app1/src/app/frames/index.ts
````typescript
export * from './analysis.frame';
export * from './debrief.frame';
export * from './dock.frame';
export * from './handoff.frame';
export * from './mission.frame';
export * from './ops-shell.frame';
````

## File: apps/app1/src/app/frames/mission.frame.ts
````typescript
import { inject } from '@angular/core';
import {
  frame,
...
## File: apps/app1/src/app/frames/ops-shell.frame.ts
````typescript
...
## File: apps/app1/src/app/services/operations-room.service.ts
````typescript
import {
  Injectable,
  signal,
...
## File: apps/app1/src/app/app.config.ts
````typescript
import {
  ApplicationConfig,
  ApplicationModule,
...
## File: apps/app1/src/app/app.routes.ts
````typescript
import {
  address,
  layout,
...
## File: apps/app1/src/index.html
````html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Switchboard Operations Room</title>
    <base href="/" />
...
## File: apps/app1/src/styles.css
````css
@import url('https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;500;600;700&family=Inter:wght@400;500;600;700&display=swap');

/*
  Design language: "brass-and-cream instrument panel" -- a warm, aged
  cockpit housing (cream/brass neutrals, not cool steel) with a single cool
  cyan phosphor readout, the way an old radar scope glows against a warm
  wooden console. The warmth carries the "well-worn hardware" feeling;
  cyan stays reserved for the one thing you're meant to watch.
*/
:root {
  color-scheme: dark;

  --app-bg:
    radial-gradient(circle at 12% 8%, rgb(94 214 255 / 0.06), transparent 30%),
    radial-gradient(circle at 88% 92%, rgb(232 162 92 / 0.07), transparent 32%),
    linear-gradient(180deg, #0d0906 0%, #14100a 40%, #17130d 70%, #0a0705 100%);

  --panel-base: rgb(20 16 12 / 0.86);
  --panel-strong: rgb(23 19 14 / 0.94);
  --panel-deep: rgb(9 7 5 / 0.97);

  --ink-strong: #998b72;
  --ink-body: #897f71;
  --ink-soft: #776a58;

  --line-soft: rgb(214 188 148 / 0.14);
  --line-strong: rgb(214 188 148 / 0.26);

  --signal-cyan: #4f92a8;
  --signal-cyan-dim: #2f7c90;
  --signal-amber: #e8a25c;
  --signal-crimson: #ff5470;
  --signal-deep: #070503;

  --stage-shadow:
    0 22px 54px rgb(0 0 0 / 0.5),
    0 0 0 1px rgb(214 188 148 / 0.05);
  ...
  --ruler-ticks:
    repeating-linear-gradient(
      90deg,
      rgb(214 188 148 / 0.18) 0,
      rgb(214 188 148 / 0.18) 1px,
      transparent 1px,
      transparent 0.6rem
    );
}
...
::selection {
  background: rgb(90 217 255 / 0.28);
  color: var(--ink-strong);
}
...
## File: apps/app1/tsconfig.app.json
````json
...
## File: apps/app1/tsconfig.spec.json
````json
/* To learn more about Typescript configuration file: https://www.typescriptlang.org/docs/handbook/tsconfig-json.html. */
/* To learn more about Angular compiler options: https://angular.dev/reference/configs/angular-compiler-options. */
{
...
## File: libraries/switchboard/src/lib/adapter-utils.ts
````typescript
...
## File: libraries/switchboard/src/lib/frame-routes.ts
````typescript
...
## File: libraries/switchboard/src/lib/history.ts
````typescript
...
## File: libraries/switchboard/src/lib/index.ts
````typescript
...
## File: libraries/switchboard/src/lib/navigation-definitions.ts
````typescript
...
## File: libraries/switchboard/src/lib/navigation-targets.ts
````typescript
...
## File: libraries/switchboard/src/lib/query-schema.ts
````typescript
...
## File: libraries/switchboard/src/lib/route-adapter.ts
````typescript
import {
...
## File: libraries/switchboard/src/lib/route-builders.ts
````typescript
...
## File: libraries/switchboard/src/lib/route-compiler.ts
````typescript
import {
  buildAddressRoutes,
  buildFrameRoutes,
...
## File: libraries/switchboard/src/lib/route-renderer.ts
````typescript
import {
  ApplicationRef,
  EnvironmentInjector,
...
## File: libraries/switchboard/src/lib/router-events.ts
````typescript
...
## File: libraries/switchboard/src/lib/router-link.ts
````typescript
import {
  DOCUMENT,
} from '@angular/common';
...
## File: libraries/switchboard/src/lib/router-outlet.ts
````typescript
...
## File: libraries/switchboard/src/lib/router-url.ts
````typescript
...
## File: libraries/switchboard/src/lib/router.ts
````typescript
...
## File: libraries/switchboard/src/lib/typed-navigation.ts
````typescript
import type {
  InferParamType,
  InferQueryInputType,
...
## File: libraries/switchboard/src/lib/vanilla-router.ts
````typescript
...
## File: libraries/switchboard/src/tests/adapters.spec.ts
````typescript
...
## File: libraries/switchboard/src/tests/angular-testbed.init.ts
````typescript
import {
  TestBed,
  getTestBed,
...
## File: libraries/switchboard/src/tests/env.spec.ts
````typescript
...
## File: libraries/switchboard/src/tests/outlet-isolation.spec.ts
````typescript
...
## File: libraries/switchboard/src/tests/query-schema.spec.ts
````typescript
...
## File: libraries/switchboard/src/tests/router-facade.spec.ts
````typescript
import { ensureAngularTestEnvironment } from './angular-testbed.init';
...
## File: libraries/switchboard/src/tests/router-link.spec.ts
````typescript
import { ensureAngularTestEnvironment } from './angular-testbed.init';
...
## File: libraries/switchboard/src/tests/router.spec.ts
````typescript
...
## File: libraries/switchboard/src/tests/typed-navigation.spec.ts
````typescript
import {
  address,
  frame,
...
## File: libraries/switchboard/src/public-api.ts
````typescript
/** Public API surface of the navigation library. */
export * from './lib';
````

## File: libraries/switchboard/ng-package.json
````json
{
...
## File: libraries/switchboard/package.json
````json
{
...
## File: libraries/switchboard/README.md
````markdown
# Switchboard
...
## File: libraries/switchboard/tsconfig.lib.json
````json
/* To learn more about Typescript configuration file: https://www.typescriptlang.org/docs/handbook/tsconfig-json.html. */
/* To learn more about Angular compiler options: https://angular.dev/reference/configs/angular-compiler-options. */
{
...
## File: libraries/switchboard/tsconfig.lib.prod.json
````json
/* To learn more about Typescript configuration file: https://www.typescriptlang.org/docs/handbook/tsconfig-json.html. */
/* To learn more about Angular compiler options: https://angular.dev/reference/configs/angular-compiler-options. */
{
...
## File: libraries/switchboard/tsconfig.spec.json
````json
/* To learn more about Typescript configuration file: https://www.typescriptlang.org/docs/handbook/tsconfig-json.html. */
/* To learn more about Angular compiler options: https://angular.dev/reference/configs/angular-compiler-options. */
{
