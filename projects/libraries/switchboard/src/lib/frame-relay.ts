...
export interface RelayRuntime {
  ...
  send(origin: FrameNode, target: RelayTarget, input?: RelayInput): Promise<boolean>;
...
export class Relay {
  ...
  to(target: RelayTarget, input?: RelayInput): Promise<boolean> { return this.runtime.send(this.origin, target, input); }
  href(target: RelayTarget, input?: RelayInput): string | null { return this.runtime.link(this.origin, target, input); }
}
