...
import { frame, lazyView, s } from '@epikodelabs/switchboard';
...
export const analysisFrame = frame(
  'analysis',
  lazyView(() => import('../components/analysis.page').then(module => module.AnalysisPage)),
  {
    directEntry: true,
    transitions: ['mission', 'handoff'],
    params: {
    ...
    outlets: {
      sidebar: AnalysisSidebarComponent,
    },
